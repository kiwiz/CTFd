...
let API = (function() {
     ...
     * 
     * @method
     * @name API#post_notificantion_list
     * @param {object} parameters - method options and parameters
     */
    API.prototype.post_notificantion_list = function(parameters) {
        if (parameters === undefined) {
            parameters = {};
        }
        let deferred = Q.defer();
     ...
     * 
     * @method
     * @name API#get_notificantion_list
     * @param {object} parameters - method options and parameters
     */
    API.prototype.get_notificantion_list = function(parameters) {
        if (parameters === undefined) {
            parameters = {};
        }
        let deferred = Q.defer();
